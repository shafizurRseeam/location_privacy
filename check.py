...
def main(base_train_directory, base_test_directory):
    ...
    mechanisms = ['laplace', 'staircase', 'our_bl_50_delta_5', 'our_bl_50_delta_10', 'our_bl_50_delta_15', 'our_bl_50_delta_20', 'our_bl_20_delta_5', 'our_bl_200_delta_5', 'our_bl_500_delta_5']
